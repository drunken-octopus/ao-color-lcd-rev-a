...
void Main_Screen (void)
{
     ...
     LCD_Cmd_Draw_Text(&X_Pos_Title);

     LCD_Cmd_Draw_Text(&Y_Pos_Title);

     LCD_Cmd_Draw_Text(&Z_Pos_Title);


     // Draw Status Button as Flat Button for Display Only

     LCD_Cmd_Set_Foreground_Color(Status.color_r, Status.color_g, Status.color_b);

     LCD_Cmd_Draw_Button(&Status);
